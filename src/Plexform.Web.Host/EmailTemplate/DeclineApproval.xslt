            ...
            <tr>
                <td width="100%" align="center">
                    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial,Helvetica,sans-serif;background-color:#fff;">
                        ...
                        <tr>
                            ...
                            <td id="iconSection" width="550" align="center">
                                <table align="center" cellpadding="0" cellspacing="0">
                                    <tr><td height="10"></td></tr>
                                    <tr><td align="center"><img src="http://218.208.21.89//eServicePublish/EmailTemplate/emailReject.png" width="300"/></td></tr>
                                    <tr><td height="30"></td></tr>
                                    <tr>
                                        <td>
                                        <table align="center" cellspacing="0" cellpadding="0" width="500">
                                        <tr>
                                            <td style="color: rgb(255, 162, 82);font-family: arial;margin-bottom: 7px;font-weight: 500; margin-top: 0;font-size: 22px;text-align: center;">
                                            The following approval request had been declined
                                            </td>
                                        </tr>
                                        </table>
                                        </td>
                        ...
                        <tr><td colspan="3" height="1" width="100%" style="background-color:#ccc"></td></tr>
                        <tr><td colspan="3" height="12"></td></tr>
                        <tr><td colspan="3" align="center" width="100%" style="font-size:15px">Please login to review</td></tr>
                        <tr><td colspan="3" height="8"></td></tr>
                        <tr>
                            <td  colspan="3">
                                <a href="[EmailActionLink]" style="text-decoration: none;">
                                    <table align="center" cellspacing="0" cellpadding="10" style="background-color:rgb(68, 184, 157)" width="200">
                                        <tr><td style="font-family: Arial, Helvetica, sans-serif;color:#fff;font-size:16px;text-transform: uppercase;text-align: center;">Login</td></tr>
                                    </table>
                                </a>
                            </td>
                        </tr>
