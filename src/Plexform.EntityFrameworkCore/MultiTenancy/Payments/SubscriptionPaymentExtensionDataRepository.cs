...
{
    public class SubscriptionPaymentExtensionDataRepository : PlexformRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<PlexformDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
