...
{
    public partial class Added_QUESTIONPAXITEM_Table20200709 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QUESTIONPAXITEM", x => new { x.QuizID, x.BizRegID, x.BizLocID, x.SecNo, x.GrpNo, x.SeqNo });
                });
        }
