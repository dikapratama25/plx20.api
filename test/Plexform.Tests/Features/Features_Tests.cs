...
using Plexform.Authorization.Users.Dto;
using Plexform.Editions;
using Plexform.Editions.Dto;
using Plexform.Features;
using Plexform.Test.Base;
using Shouldly;
using Xunit;

namespace Plexform.Tests.Features
{
    ...
    public class Features_Tests : AppTestBase
    {
        ...
        public async Task Should_Not_Create_User_More_Than_Allowed_Count()
        {
            ...
            exception.Message.ShouldContain(_localizationManager.GetString(PlexformConsts.LocalizationSourceName, "MaximumUserCount_Error_Message"));
        }
    }
}
