...
using Plexform.MultiTenancy.HostDashboard;
using Plexform.MultiTenancy.HostDashboard.Dto;
using Plexform.MultiTenancy.Payments;
using Shouldly;
using System.Globalization;
using Plexform.EntityFrameworkCore;

namespace Plexform.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PlexformDbContext context, SubscriptionPayment subscriptionPayment)
        {
